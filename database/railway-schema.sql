...
CREATE TABLE IF NOT EXISTS products (
    ...
    brand VARCHAR(100),
    species VARCHAR(50),
    breed_size VARCHAR(20) DEFAULT NULL,
    age_group VARCHAR(20) DEFAULT NULL,
    health_category VARCHAR(50) DEFAULT NULL,
    ...
    unit_type ENUM('piece','kg','g','liter','ml') DEFAULT 'piece',
...
VALUES ('admin', 'admin@risha.com', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Admin', 'admin', TRUE)
